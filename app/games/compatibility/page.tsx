  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 pb-12">
      ...
      <div className="soft-card rounded-3xl p-6 sm:p-10 border border-border relative overflow-hidden text-center space-y-6">
        <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-pink-500/10 border border-border text-pink-300 text-xs font-semibold">
        ...
        {!isFinished ? (
            ...
            <div className="space-y-3 pt-2">
              {currentQ.options.map((opt, idx) => (
                <button
                  ...
                  className="w-full p-4 rounded-xl border border-zinc-800 bg-zinc-900/80 hover:bg-rose-500/20 hover:border-border text-zinc-200 text-sm font-semibold transition-all text-left flex items-center justify-between group"
                >
                  <span>{opt}</span>
          ...
          <div className="space-y-6 py-4">
            <div className="inline-flex items-center justify-center w-24 h-24 rounded-full text-white shadow-xl shadow-rose-500/30 text-3xl font-black">
              {percent}%
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 max-w-sm mx-auto">
              <div className="p-4 rounded-2xl bg-emerald-500/10 border border-border text-center">
